...
public class TripExchangeCurrencyDTO {
    ...
    public TripExchangeCurrencyDTO(Integer tripId, String name, String country, BigDecimal goalAmount, LocalDate endDate, BigDecimal amount, BigDecimal amountUS, BigDecimal totalAmountInKRW, BigDecimal totalProfit) {
        this.tripId = tripId;
        this.name = name;
